...
ScreenControlSliderStrengthViewBase::ScreenControlSliderStrengthViewBase() :
    buttonCallback(this, &ScreenControlSliderStrengthViewBase::buttonCallbackHandler)
{
    ...
    image5.setXY(74, 59);
    image5.setBitmap(touchgfx::Bitmap(BITMAP_STRENGTH_IMAGE_LARGE_ID));
    Background.add(image5);

    textArea1.setXY(47, 37);
    ...
    buttonSave.setLabelText(touchgfx::TypedText(T_SINGLEUSEID22));
    ...
    textArea3.setXY(97, 172);
    textArea3.setColor(touchgfx::Color::getColorFrom24BitRGB(1, 31, 111));
    textArea3.setLinespacing(0);
    textArea3.setTypedText(touchgfx::TypedText(T_SINGLEUSEID21));
...
void ScreenControlSliderStrengthViewBase::setupScreen()
{

}

void ScreenControlSliderStrengthViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    if (&src == &buttonSave)
    {
        //Interaction1
